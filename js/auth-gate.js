...
(function () {
  ...
  function createGate() {
    ...
    overlay.innerHTML = [
      ...
      '    </svg>',
      '  </div>',
      '  <h2 class="mag-title">Protected portal</h2>',
      '  <p class="mag-sub">This is the password for the protected tools portal — it is separate from your client password. If you don\'t have it, please request it from your majaco contact.</p>',
      '  <form class="mag-form" autocomplete="off">',
      '    <input class="mag-input" type="password" placeholder="Portal password" autocomplete="off" autofocus />',
      '    <button class="mag-btn" type="submit">Unlock</button>',
      '  </form>',
      '  <p class="mag-error"></p>',
      '  <p class="mag-hint">Clients will be prompted for their own portal password in the next step.</p>',
